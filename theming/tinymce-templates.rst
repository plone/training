...
We already have a folder named ``tinymce_templates`` in our theme folder. So we just need to add a file named ``content-box.html`` into the this folder:
   ...
   <registry>
     ...
     <record name="plone.templates" interface="Products.CMFPlone.interfaces.controlpanel.ITinyMCESchema" field="templates">
       ...
       <value>[
         ...
         {"title": "Content box", "url": "++theme++plonetheme.tango/tinymce_templates/content-box.html"}
         ]
       </value>
     </record>
