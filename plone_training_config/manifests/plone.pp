...
extends-cache = /home/vagrant/buildout-cache/extends'),
    ...
    exec {'wget https://launchpad.net/plone/5.0/5.0rc2/+download/Plone-5.0rc2-UnifiedInstaller.tgz':
        alias => "download_installer",
        creates => '/home/vagrant/tmp/Plone-5.0rc2-UnifiedInstaller.tgz',
    ...
    exec {'tar xzf Plone-5.0rc2-UnifiedInstaller.tgz':
        alias => "untar_installer",
        creates => '/home/vagrant/tmp/Plone-5.0rc2-UnifiedInstaller',
        cwd => '/home/vagrant/tmp',
        user => 'vagrant',
    ...
    exec {'/home/vagrant/tmp/Plone-5.0rc2-UnifiedInstaller/install.sh standalone --with-python=/home/vagrant/py27/bin/python --password=admin --instance=zinstance --target=/home/vagrant/Plone':
        alias => "install_plone",
    ...
    exec {'cp -Rf /home/vagrant/Plone/buildout-cache/* /home/vagrant/buildout-cache/':
        alias => "copy_cache",
        creates => '/home/vagrant/buildout-cache/eggs/Products.CMFPlone-5.0rc2-py2.7.egg/',
        user => 'vagrant',
        cwd => '/home/vagrant',
