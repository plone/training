...
See Plone's default bundle, i.e. [plone-base.js](https://github.com/plone/plone.staticresources/blob/1.x/src/plone/staticresources/static/plone-base.js#L44). Be aware that the link targets the branched out Plone 5 `plone.staticresources` (branch `1.x`). 
