...
- chapter deployement "deployment_sites" update to installation without buildout
- embed.md Do we want training.votable as a dependency? What about this magic event handler on auto publishing talks`? maybe replace by a more real life event handler.
