...
This data written by the reducer is the response of the request to \<backend>/

<mailto:api/@votes>

 :

<http://greenthumb.ch/api/@votes>

 if your backend is available at 

<http://greenthumb.ch>

It is the data that adapter 

`Vote`

 from starzel.votable_behavior behavior/voting.py provides and exposes via REST API endpoint @votes.
