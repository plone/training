...
It is more important to pay attention to how the integration with the theme works,
...
configuration settings of ``development-css``, ``production-css``, ``development-js`` and ``production-js``.
