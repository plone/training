...
We will stay very simple for the sake of brevity,
using `jQuery <https://jquery.com/>`_ to do an animation effect on the title of the page:
...
To register it, you need to add :term:`ZCML` registration for the static directory your script
is in.
...
and we can use the main template to bring in the content of the page
we are using in the JavaScript(h1).
